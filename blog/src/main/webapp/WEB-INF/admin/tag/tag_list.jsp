...
<link rel="stylesheet" type="text/css"
	href="js/flavr/flavr/css/animate.css" />
<link rel="stylesheet" type="text/css"
	href="js/flavr/flavr/css/flavr.css" />
<link rel="stylesheet"
...
<body>
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li class="active"><a href="javascript:void(0)"><i
					...
					<ul class="nav nav-second-level">
						<li class="active"><a href="admin/tag/list">标签列表</a>
						</li>
					</ul></li>
				<li><a href="javascript:void(0)"><i class="fa fa fa-qrcode"></i>
	...
	<script type="text/javascript"
		src="js/flavr/flavr/js/flavr.min.js"></script>
	<script type="text/javascript" src="js/flavr/base.js"></script>
	<script type="text/javascript"
		src="js/zTree_v3/js/jquery.ztree.all-3.5.js"></script>
